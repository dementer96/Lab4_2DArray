...
public class TwoDimArrayPractice extends JFrame
{
   ...
   public void printArray() {
	    ...
	    for (int row = 0; row < intArray.length; row++) {
	        ...
	        for (int column = 0; column < intArray[row].length; column++) {
	            ...
	            // Call animate as the last statement in the inner loop
	            animate(row, column);
	        }
	        System.out.println();
	    }
   ...
   public void setValues(int value, int row) {
	    if (row >= 0 && row < intArray.length) {
	        for (int column = 0; column < intArray[row].length; column++) {
	            ...
	            // Animate after setting the value
	            animate(row, column); 
	        }
	    } else {
   ...
   */
   ...
   {
	   if (intArray.length == 0 || intArray[0].length == 0) {
	...
	// Initialize min with the first value in the column
	    ...
	    for (int row = 1; row < intArray.length; row++) {
	    	...
	    	if (currentValue < min) {
	            min = currentValue; // Update minimum if current value is smaller
	        }

	        // Animate the current position being checked
	    	animate(row, column, currentValue);
	    }
	    return min;
   }
   ...
   */
   ...
   {
	   int count = 0; // Initialize a counter for the frequency of the value
	    ...
	    for (int row = 0; row < intArray.length; row++) {
	        ...
	        for (int column = 0; column < intArray[row].length; column++) {
	            ...
	            // Animate the current position being checked, including the frequency count
